        ...
        <div className="prose prose-base md:prose-lg dark:prose-invert max-w-none">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="/palettes" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-indigo-300 dark:border-indigo-600 text-indigo-600 dark:text-indigo-400 text-sm font-semibold hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors">
