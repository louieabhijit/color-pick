    ...
    <div className="min-h-screen">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        <div className="prose prose-base md:prose-lg dark:prose-invert max-w-none">
          ...
          >
            <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">Build your brand palette</h3>
            <p className="text-[var(--text-muted)] mb-6 text-sm">Turn color psychology insights into a concrete, exportable palette for your project.</p>
            <div className="flex flex-wrap gap-3">
              ...
              <a href="/palette-exporter" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-indigo-300 dark:border-indigo-600 text-indigo-600 dark:text-indigo-400 text-sm font-semibold hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-colors">
                Export Palette (CSS/Tailwind/JSON)
              </a>
            </div>
          </motion.div>
